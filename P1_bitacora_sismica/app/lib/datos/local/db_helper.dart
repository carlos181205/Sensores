...
class ColaImpacto {
  ...
  factory ColaImpacto.fromMap(Map<String, dynamic> map) {
    return ColaImpacto(
      ...
      precisionM: (map['precision_m'] as num?)?.toDouble() ?? 0.0,
  ...
  Future<Database> _initDatabase() async {
    ...
    return openDatabase(
      ...
      onUpgrade: (db, oldVersion, newVersion) async {
        if (oldVersion < 2) {
          await db.execute('ALTER TABLE cola_impactos ADD COLUMN precision_m REAL DEFAULT 0.0');
        }
      },
    );
  }
