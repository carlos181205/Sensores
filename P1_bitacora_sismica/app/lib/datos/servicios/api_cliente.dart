...
class ApiCliente {
  ...
  Exception _mapError(DioException e) {
    ...
    if (e.response != null) {
      ...
      final message = data is Map ? data['message'] ?? 'Error del servidor' : 'Error del servidor';
      return Exception(message);
    }

    return Exception('Error inesperado al consumir la API');
  }
}
